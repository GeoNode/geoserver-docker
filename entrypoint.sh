...
then
    ...
    echo "Found an existing data directory"
fi
...
then
    ...
    echo "Found a geonodeAuthProvider config, archiving"
...
then
    echo " Copying geonode REST role configuration"
...
echo "Setting up geonode REST role service"
...
echo "Backing up geonode-oauth2 configuration"
...
echo "Setting up geonode-oauth2"
...
echo "Backing up global configuration"
# backup global.xml
